...
else if (perguntaInicio === false) {
   console.log("Ah, que pena, você nao quis iniciar uma partida")
}
...
if (deckComputador1.texto+deckComputador1.texto === "AA"){
   novaCartaComputador = comprarCarta()
}
if (deckUsuario2.texto+deckUsuario2.texto === "AA"){
